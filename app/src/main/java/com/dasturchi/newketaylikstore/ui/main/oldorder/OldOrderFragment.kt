package com.dasturchi.newketaylikstore.ui.main.oldorder
...
import com.dasturchi.newketaylikstore.adapter.OldOrderAdapter
import com.dasturchi.newketaylikstore.databinding.FragmentOrderOldBinding
import com.dasturchi.newketaylikstore.ui.auth.LoginActivity
import com.dasturchi.newketaylikstore.ui.main.MainListener
import com.dasturchi.newketaylikstore.ui.main.order.OrderViewModel
...
class OldOrderFragment : Fragment(), KodeinAware, MainListener {
    override val kodein by kodein()
    private val factory: OrderViewModelFactory by instance()
    private val pref: PreferenceProvider by instance()

    private lateinit var binding: FragmentOrderOldBinding
    private lateinit var orderViewModel: OrderViewModel
    private var mAdapter = OldOrderAdapter()
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_order_old, container, false)
